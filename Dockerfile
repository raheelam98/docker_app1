...
# step:- Set environments, Install Poetry
...
# setp:- Install dependencies including development 
RUN poetry install

# note:- Configuration to avoid creating virtual environments inside the Docker container
# poetry config virtualenvs.create false

# step:-  Copy the current directory contents into the container at /code
COPY . /code/
